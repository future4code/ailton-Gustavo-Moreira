...
-- Respostas do dia
-- 1 A) Removde a coluna salary
-- B) vai mudar o nome da coluna gender  para sex com até 6 palavras
-- C) vai mudar o nome da coluna gender  para string padrao
-- 2 D) informa que a coluna é desconhecida.
-- 5 A) ele pegou o numuro maximo de cada tipo de genero
-- 6 D) Não da erro, mas também nao atualiza, pois nao tem id 3.
-- 7 A) 2 filmes B) a media é 9 C) 2 FILMES  D) 0 E) 10 F) 7
